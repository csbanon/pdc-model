...
## Description
The *Preferential Deletion Model with Changes in Existing Connections (PDCModel)* is an extension of the discrete-time dynamic random graph generator developed by Narsingh Deo and Aurel Cami for their 2005 study *Preferential Deletion in Dynamic Models of Web-like Networks*.
